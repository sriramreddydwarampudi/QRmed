...
import 'package:supreme_institution/widgets/visitor_home_tab.dart';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            NotificationBell(targetUserId: widget.collegeName),
            IconButton(
        ...
        body: TabBarView(
          children: [
            VisitorHomeTab(associatedCollege: _associatedCollege!),
